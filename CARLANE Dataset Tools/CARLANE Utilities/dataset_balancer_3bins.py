...
if __name__ == '__main__':
    ...
    parser.add_argument("--root_dir", type=str, default="./TuLane/data/train/sim/", help="root directory where the images are placed")
    parser.add_argument("--label_root_path", type=str, default="./TuLane/splits/", help="root directory where the labels are placed")
    parser.add_argument("--imgs_per_dir", type=int, default=2000, help="amount of images per folder")
