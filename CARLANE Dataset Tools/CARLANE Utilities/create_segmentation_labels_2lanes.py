...
def get_tusimple_list(label_list):
    """
...
def generate_segmentation_and_train_list(root, new_file, line_txt, names):
    """
...
if __name__ == "__main__":
    root = "./MoLane/data/"
    label_files = ["./MoLane/splits/target_test.json"]
    new_file = "./MoLane/splits/target_test.txt"

    # images with labels [source_train, source_val, target_val, target_test]
    names, line_txt = get_tusimple_list(label_files)
    generate_segmentation_and_train_list(root, new_file, line_txt, names)
