...
def save_model(target_cnn, discriminator, optimizer, optimizer_disc, epoch, save_path):
    if is_main_process():
        state = {
            'encoder': target_cnn.encoder.state_dict(),
            'classifier': target_cnn.classifier.state_dict(),
            'discriminator': discriminator.state_dict(),
            'optimizer_enc': optimizer.state_dict(),
